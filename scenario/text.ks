...
[image storage="image/system/text/base" layer=base page=fore]
[locate x=438 y=205]
...
;テキストの色
[locate x=386 y=290]
[button graphic= "image/system/button/check_on.png" onenter="hover_on('【テキストの色】 ','テキストの色を変更できます。','●【グレー】 テキストの色をグレーにする。','●【白】 テキストの色を白にする。');sse_play(true);" onleave="sse_stop();hover_off()" cond="sf.text_color==0"]
[locate x=506 y=290]
[button graphic= "image/system/button/check_off.png" onenter="hover_on('【テキストの色】 ','テキストの色を変更できます。','●【グレー】 テキストの色をグレーにする。','●【白】 テキストの色を白にする。');sse_play(true);" onleave="sse_stop();hover_off()" target=*text_white cond="sf.text_color==0"]
[locate x=386 y=290]
[button graphic= "image/system/button/check_off.png" onenter="hover_on('【テキストの色】 ','テキストの色を変更できます。','●【グレー】 テキストの色をグレーにする。','●【白】 テキストの色を白にする。');sse_play(true);" onleave="sse_stop();hover_off()" target=*text_grey  cond="sf.text_color==1"]
[locate x=506 y=290]
[button graphic= "image/system/button/check_on.png" onenter="hover_on('【テキストの色】 ','テキストの色を変更できます。','●【グレー】 テキストの色をグレーにする。','●【白】 テキストの色を白にする。');sse_play(true);" onleave="sse_stop();hover_off()" cond="sf.text_color==1"]
...
[eval exp="f.previous_font_face='ロダン'" cond="sf.font==0"]
[eval exp="f.previous_font_face='筑紫a'" cond="sf.font==1"]
[eval exp="f.previous_font_face='スーラ'" cond="sf.font==2"]
[eval exp="kag.inStable=true"]
[if exp="sf.text_color"]
	[current layer="message6"]
	[deffont face=&f.previous_font_face color=0xffffff edgecolor=0x777777]
	[resetfont]
[else]
	[current layer="message6"]
...
*font_2
[eval exp="sf.font=1"]
[eval exp="f.previous_font_face='筑紫a'"]
[eval exp="kag.chDefaultFace = f.previous_font_face"]
[eval exp="kag.setMessageLayerUserFont()"]
[if exp="sf.text_color"]
	[current layer="message6"]
...
*font_3
[eval exp="sf.font=2"]
[eval exp="f.previous_font_face='スーラ'"]
[eval exp="kag.chDefaultFace = f.previous_font_face"]
[eval exp="kag.setMessageLayerUserFont()"]
[if exp="sf.text_color"]
	[current layer="message6"]
